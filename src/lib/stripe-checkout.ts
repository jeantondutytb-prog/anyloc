...
export async function createSubscriptionCheckoutSession({
  ...
  if (uiMode === "embedded_page") {
    return stripe.checkout.sessions.create({
      ...
      return_url: `${appUrl}/dashboard/installation?success=true&session_id={CHECKOUT_SESSION_ID}`,
    });
  }
  ...
  return stripe.checkout.sessions.create({
    ...sharedParams,
    ui_mode: "hosted_page",
    success_url: `${appUrl}/dashboard/installation?success=true&session_id={CHECKOUT_SESSION_ID}`,
